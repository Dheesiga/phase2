...
const CryptoDetails = () => {
  ...
  return ReactDOM.createPortal(
    <div
      className="fixed top-[100px] right-0 w-[50%] h-[80%] first-letter:
     flex items-center justify-center font-nunito
    "
      onClick={close}
    >
      <div
        className="w-full h-[80%] bg-gray-800 bg-opacity-75 rounded-lg text-black relative"
          ...
          <div className="flex items-center justify-between h-full w-full p-4">
            <div className="flex flex-col w-[45%] h-full pr-2 ">
              <div className="flex w-full items-center">
                ...
                <span
                  className="text-sm
        py-0.5 px-2.5 ml-2 bg-black text-black bg-opacity-25
        rounded uppercase
        "
                >
                  {data.symbol}
